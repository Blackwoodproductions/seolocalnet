...
const platformFeatures = [
  "Full white-label dashboard with your branding",
  "Real-time keyword ranking across all major search engines",
  "AI-powered competitor content analysis",
  "Automated citation and backlink building",
  "Detailed analytics and visitor tracking",
  "Google My Business integration",
  "Multi-search engine rank tracking (Google, Yahoo, Bing)",
  "Map Pack, Rich Snippet, and AI Overview monitoring",
];
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            {/* CTA */}
            <a href="#demo" className="btn-futuristic inline-flex items-center gap-2">
              <Play size={18} />
              Watch Demo
            </a>
          </motion.div>
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="grid grid-cols-4 gap-3">
                    {[
                      ...
                      { value: "3.4K", label: "Visits", trend: "+100%" },
                      { value: "3.1K", label: "Visitors", trend: "+100%" },
                      { value: "0:16", label: "Duration", trend: "+100%" },
                    ].map((stat, i) => (
                    ...
                    <div className="flex items-end gap-1 h-24">
                      {[40, 65, 55, 80, 70, 90, 75, 85, 95, 70, 85, 100].map((height, i) => (
                        <div key={i} className="flex-1 flex flex-col gap-0.5">
                          ...
                          ></div>
                          <div
                            className="bg-gradient-to-t from-accent/60 to-accent/30 rounded-t"
