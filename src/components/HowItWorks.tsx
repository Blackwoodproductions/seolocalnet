...
const steps = [
  {
    ...
    description:
      "Add your agency clients to the platform. Each gets their own branded dashboard with your logo and colors.",
  },
  {
    number: "02",
    icon: FolderOpen,
    ...
    description:
      "Every client website is categorized into our niche network. Our AI analyzes competitors and top-ranking content.",
  },
  {
    number: "03",
    icon: Sparkles,
    ...
    description:
      "Our engine reverse-engineers what's working and creates content that's built to outrank the competition.",
  },
  {
    number: "04",
    icon: TrendingUp,
    ...
    description:
      "Relevant backlinks flow automatically from our network of 1000s of real business sites. Watch rankings climb.",
  },
];
